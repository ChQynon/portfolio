...
import { ArrowLeft, Code, Server, Braces } from "lucide-react"
...
export default function Skills() {
  ...
  useEffect(() => {
    ...
    // Trigger skills animation after main content appears
    setTimeout(() => {
    ...
    <main className="min-h-screen p-6 md:p-12">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className={`${skillsVisible ? "animate-fade-in delay-200" : "opacity-0"}`}>
            <div className="flex items-center mb-6">
              <Braces className="w-5 h-5 text-gray-400 mr-2" />
              <h2 className="text-xl font-semibold">Языки программирования</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {programmingSkills.map((skill, index) => (
                <a
                  ...
                  className="card-gradient border border-gray-800 rounded-lg p-4 transition-all duration-300 hover:border-primary/50 hover:-translate-y-1"
                >
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <span className="text-sm text-green-500">In active use</span>
                  </div>
                </a>
              ))}
            </div>
          ...
          {/* Фронтенд */}
          <div className={`${skillsVisible ? "animate-fade-in delay-300" : "opacity-0"}`}>
            <div className="flex items-center mb-6">
              <Code className="w-5 h-5 text-gray-400 mr-2" />
              <h2 className="text-xl font-semibold">Фронтенд</h2>
            </div>
          ...
          {/* Бекенд */}
          <div className={`${skillsVisible ? "animate-fade-in delay-400" : "opacity-0"}`}>
            <div className="flex items-center mb-6">
              <Server className="w-5 h-5 text-gray-400 mr-2" />
              <h2 className="text-xl font-semibold">Бекенд</h2>
            </div>
